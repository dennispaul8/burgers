...
export default function DonationCard({ donation }) {
    ...
    useEffect(() => {
        ...
        const ensureTwitter = () => new Promise((resolve) => {
            if (window.twttr && window.twttr.widgets) {
                return resolve();
            }
            const existing = document.querySelector("#twitter-wjs");
            if (existing) {
        ...
        ensureTwitter().then(() => {
            ...
            const alreadyRendered = !!container &&
    ...
    return (_jsx("div", { ref: containerRef, className: "bg-none rounded-xl p-4 sm:p-6 w-full max-w-md mx-auto text-center overflow-hidden", children: donation.tweetUrl ? (_jsxs(_Fragment, { children: [loading && (_jsx("div", { className: "flex items-center justify-center h-32", children: _jsx("div", { className: "animate-spin rounded-full h-8 w-8 border-b-2 border-white" }) })), _jsx("div", { className: "w-full max-w-full", children: _jsx("blockquote", { className: "twitter-tweet w-full", "data-theme": "dark", style: {
                            display: loading ? "none" : "block",
                            margin: 0,
                        }, children: _jsx("a", { href: donation.tweetUrl }) }) })] })) : (_jsx("p", { className: "text-gray-200 mb-3 whitespace-pre-line text-sm sm:text-base break-words" })) }));
}
